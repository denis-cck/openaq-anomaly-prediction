...
class LocationsTable(BaseTable):
    ...
    def __init__(self):
        ...
        self.dataset_id = LOCATIONS_TABLE_CONFIG["dataset_id"]
        self.table_id = LOCATIONS_TABLE_CONFIG["table_id"]

        self.schema = LOCATIONS_TABLE_CONFIG["schema"]
        self.partitioning = LOCATIONS_TABLE_CONFIG["partitioning"]
        self.clustering_fields = LOCATIONS_TABLE_CONFIG["clustering_fields"]
        self.primary_keys = LOCATIONS_TABLE_CONFIG["primary_keys"]
        self.foreign_keys = LOCATIONS_TABLE_CONFIG["foreign_keys"]
